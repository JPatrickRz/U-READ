        ...
        <div class="col-md-1 bg-customs d-flex justify-content-center">
            <ul class="nav flex-column icon-margin dashboard-menu">
              ...
              <li class="nav-item {{'trash' == request()->path() ? 'active' : ''}}" style="display:flex; justify-content:center;">
                    <a class="btn-active" href="#"><i class="bi bi-trash-fill" style="display: flex;justify-content:center"></i><h3>Trash</h3></a>
              </li>
        ...
        <div class="col-md-2 bg-custom d-flex flex-column align-items-center pt-5">
            ...
            <div class="mt-4">
                <ul style="list-style-type: none; font-size: 18px;">
                    <li class="library-link {{'allReference' == request()->path() ? 'active' : ''}}"><a href="{{ route('allReference') }}" style="text-decoration: none;">All References</a></li>
                    <h3>Hello</h3>
